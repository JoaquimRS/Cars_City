...
function redirectDetails() {
   $(document).on("click", ".car-related", function () { //si el usuari fa click en els cotxes relacionats
       ...
       ajaxPromise("POST","JSON","module/shop/controller/controller_shop.php?op=increment_views",  idCar)
       .then((sql) => {
           loadDetails(idCar)
...
function loadRealated(carInfo) {
    ...
    ajaxPromise("POST","JSON","module/shop/controller/controller_shop.php?op=list_related_cars", carInfo[0])
    .then((jsonRelatedCars) => {
         $.each(jsonRelatedCars, (index, relatedCar) => { 
            if (relatedCar.id_coche != carInfo[0].id_coche) {
                ...
                if(relatedCar.IMG){
                    img.src = "view/img/cars/"+relatedCar.IMG
                } else {
                    img.src = "view/img/cars/error.jpg"
                }
...
function loadDetails(idCar) {
    ...
    returnShop.src="view/img/return.png"
    ...
    ajaxPromise("GET","JSON","module/shop/controller/controller_shop.php?op=list_carImages&id="+idCar)
            .then(function (carImages) {
                $.each(carImages, function(index, carImg) {
                    ...
                    carImageClick.src = "view/img/cars/"+carImg.url_img
                    ...
                    if (index == 1) {
                        ...
                        carImage.src = "view/img/cars/"+carImg.url_img
    ...
    ajaxPromise("GET","JSON","module/shop/controller/controller_shop.php?op=list_car&id="+idCar)
...
function loadFilters() {
    ...
    removeFilters.src= "view/img/filter-remove.png"
    ...
    ajaxPromise("GET","JSON","module/shop/controller/controller_shop.php?op=list_brands_models")
    ...
    ajaxPromise("GET","JSON","module/shop/controller/controller_shop.php?op=list_fuels")
    .then((jsonFuels) => {
    ...
    ajaxPromise("GET","JSON","module/shop/controller/controller_shop.php?op=list_categories")
    .then((jsonCategories) => {
    ...
    ajaxPromise("GET","JSON","module/shop/controller/controller_shop.php?op=list_cities")
    .then((jsonCities) => {
...
function loadCars(cars, notFilters=true) {
    ...
    if (notFilters==false){
        ...
        $.each(cars, function (index, car) {
            ...
            carImage.src="view/img/cars/load_img.gif"
            ...
            ajaxPromiseTimeout(500,"GET","JSON","module/shop/controller/controller_shop.php?op=list_carImages&id=" + car.id_coche)
            .then(function (carImages) {
...
function loadItems(jsonfilteredCars) {
    ...
    if (jsonfilteredCars) {
        ...
        ajaxPromise("GET","JSON","module/shop/controller/controller_shop.php?op=list_cars")
...
function ajaxForSearch() {
    ...
    ajaxPromise("POST","JSON","module/shop/controller/controller_shop.php?op=list_filter_cars", filters)
