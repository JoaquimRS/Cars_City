...
function loadCarusel(){
    ajaxPromise('GET', 'JSON', 'module/home/controller/controller_home.php?op=list_brands')
...
function loadFuels(){
    ajaxPromise('GET','JSON','module/home/controller/controller_home.php?op=list_fuels')
...
function loadCategories(){
    ajaxPromise('GET','JSON','module/home/controller/controller_home.php?op=list_categories')
