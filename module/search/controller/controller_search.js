function loadSearchBrands() {    
    ...
    ajaxPromise('GET','JSON','module/search/controller/controller_search.php?op=list_brands')
...
function loadSearchCategories() {
    ...
    ajaxPromise('GET','JSON','module/search/controller/controller_search.php?op=list_categories')
...
function loadSearchCities(jsonFilteredCities) {
    ...
    if (jsonFilteredCities) {
        ...
        if (notfilters==false){
            ...
            ajaxPromise('GET','JSON','module/search/controller/controller_search.php?op=list_cities')
...
function loadCities() {
    filters = JSON.parse(localStorage.getItem('filters'))
    ajaxPromise("POST","JSON","module/search/controller/controller_search.php?op=list_filter_cities", filters)
